...
SYMBOL_MAPPING = {
    game_classes.Symbol.Empty: " ",
    game_classes.Symbol.Ship: "■",
    game_classes.Symbol.Hit: "☒",
    game_classes.Symbol.Miss: "•",
}
    ...
    with FullscreenWindow() as window:
        with Input() as input_generator:
            ...
            if not esc_pressed:
                ...
                window.render_to_terminal(play_message + get_board_image(brd2, crosshair,  brd))
